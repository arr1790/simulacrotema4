                        ...
                        data.map((profesor) => (
                            <div key={profesor.id} className="p-4 bg-white shadow-sm rounded-md flex justify-between items-center">
                                ...
                                <div className="flex space-x-2">
                                    <Link href={`/profesores/${profesor.id}`} className="text-blue-500 hover:underline">Ver</Link>
                                    <Link href={`/profesores/${profesor.id}/modificar`} className="text-yellow-500 hover:underline">Modificar</Link>
