import { LogIn, LogOut } from "lucide-react"; //o podemos hacer importarlo desde su carpeta que esta en lib/actions 


export function Login({ action, callbackUrl }) { //lo vamos a desestructurar para obtener los parámetros
